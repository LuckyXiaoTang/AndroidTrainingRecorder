 ...
 */
class TriangleEqualColor(context: Context) : BaseDrawer(context) {
    ...
    // R-G-B-A
    private val mColorCoordinate = floatArrayOf(
        1f, 0f, 0f, 1f,
        0f, 1f, 0f, 1f,
        0f, 0f, 1f, 1f
    )
    ...
    override fun initGL() {
        ...
        mColorBuffer = GLHelper.floatArrayToBuffer(mColorCoordinate)
        mProgram = GLHelper.createProgramFromAssets(
            mContext.resources,
            "simple/vert/triangle_equal_color.vert",
            "simple/frag/triangle_equal_color.frag"
        )
    }
